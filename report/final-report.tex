...
This project uses \RunLazyLookahead, \cite{ghallabNauTraverso25.book.apl}, Algorithm~2.4. Briefly, this acting algorithm checks whether the agent has reached the goal. If an existing plan exists and \alg{Simulate} is not failure, it performs the next action in the plan. Otherwise it creates a new plan. 
